...
export const authAPI = {
  ...
  verify2fa: (userId, code) => api.post('/auth/verify-2fa', null, { params: { userId, code } }),
...
export const reportsAPI = {
  ...
  overrideReportStatus: (id, status, feedback) => api.post(`/reports/${id}/override-status`, null, { 
...
export const adminAPI = {
  ...
  getAssignedEmployees: (supervisorId) => api.get(`/admin/supervisors/${supervisorId}/employees`),
};

// Public User API (for non-admin users to get users by role)
export const userAPI = {
  getUsersByRole: (role) => api.get(`/public/users/role/${role}`),
  sendTestNotification: (data) => api.post('/public/users/test-notification', data),
};
...
export const notificationsAPI = {
  ...
  send: (data) => api.post('/notifications', null, { 
    params: { 
