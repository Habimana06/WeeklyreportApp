...
const EmployeeDashboard = () => {
  ...
  const fetchReports = async () => {
    try {
      ...
      const pending = reportsData.filter(r => r.status === 'DRAFT').length;
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-lg text-gray-600">Manage your weekly reports</p>
        </div>
        <Link
          to="/reports/create"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white dashboard-card hover-lift">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-base font-medium text-gray-600">Draft</p>
        ...
        <div className="bg-white dashboard-card hover-lift">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-base font-medium text-gray-600">Submitted</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        {reports.length === 0 && (
          <div className="text-center py-8">
            <p className="text-base text-gray-500">No reports found. Create your first report!</p>
          </div>
        )}
      </div>
    </div>
